...
- **`fetch_fresh.py`** / **`check_fresh.py`** — собирают и проверяют датасет вопросов о "свежих событиях" (фактах достаточно недавних, чтобы модель не могла ответить по памяти), который используется, чтобы оценить, действительно ли помогают инструменты.
